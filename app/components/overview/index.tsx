...
import useGetVaccines from '@/app/hooks/useGetVaccines';
import { Sidebar } from '../Sidebar';
import { FaUsers, FaSyringe, FaTimes, FaChevronDown } from 'react-icons/fa';
...
function Overview() {
  ...
  useEffect(() => {
    ...
    const vaccineChoices: string[] = child.flatMap((childData) =>
      childData.vaccineadministration_set.map((vaccineadministration_set) => vaccineadministration_set.vaccine_choice)
    );
